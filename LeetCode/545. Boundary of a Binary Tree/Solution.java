...
class Solution {
    ...
    public void leftBoundary(TreeNode current)
    {
        ...
        if(current.left == null) 
            leftBoundary(current.right);
        else 
            leftBoundary(current.left);
    }
    
    public void getLeaves(TreeNode current)
    {
        if(current == null) 
           return;
        ...
        getLeaves(current.left);
        getLeaves(current.right);
    }
    
    public void rightBoundary(TreeNode current)
    {
        if(current == null || (current.right == null && current.left == null)) 
            return;
        
        if(current.right == null)
            rightBoundary(current.left);
        else 
            rightBoundary(current.right);
